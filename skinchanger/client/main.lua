...
function LoadDefaultModel(malePed, cb)
	...
	if not model then
		characterModel = malePed and GetHashKey('mp_m_freemode_01') or GetHashKey('mp_f_freemode_01')
	else 
...
function ApplySkin(skin, clothes)
	...
	local mix_three =			Character and (Character['mix_three'] / 100) + 0.0 or 0.0
	
	SetPedHeadBlendData			(playerPed, Character['mom'], Character['dad'], 
								Character['face_3'] or 0, Character['skin1'] or Character['mom'], 
								Character['skin2'] or Character['dad'], Character['skin3'] or 0,
								face_weight, skin_weight, mix_three or 0.0, false)
